...
<html lang="en">
  ...
  <body>
    <nav class="navbar navbar-default"style="background:red;">
      <div class="container">
        
        <div id="navbar" class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            <li  style="align-self: center;"><a href="#"></a></li>
          </ul>
    ...
    <header id="header"style="background:#FA8072;">
      <div class="container">
        <div class="col-md-10">
          <h1 class="text-center">
            <span class="glyphicon glyphicon-log-in" aria-hidden="true"style="color:green;"></span>
           Admin Login <small>Abdur Rahman Pharmacy </small>
          </h1>
        </div>
       </div>
      </div>
  ...
  <p>&copy; Abdur Rahman Pharmacy All Right Reserved,  <?php echo date('Y')?>  </p>
	</footer>
